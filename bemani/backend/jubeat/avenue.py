...
class JubeatAvenue(
    ...
    def __get_global_info(self) -> Node:
        ...
        event.add_child(Node.s32('event_type', 1))
        event.add_child(Node.u64('stime', 1672667089))
        event.add_child(Node.u64('etime', 1735796677))
        event.add_child(Node.bool('is_open', True))
        event.add_child(Node.string('hint', 'len=64'))
        event.add_child(Node.string('unlock_text', 'len=128'))
